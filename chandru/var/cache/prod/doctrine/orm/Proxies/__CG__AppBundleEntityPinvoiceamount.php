 ...
 */
class Pinvoiceamount extends \AppBundle\Entity\Pinvoiceamount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'paiddate', 'amount', 'pinvoice', 'balance'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pinvoiceamount $proxy) {
