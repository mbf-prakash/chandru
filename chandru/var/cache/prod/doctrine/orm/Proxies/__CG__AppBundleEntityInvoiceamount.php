 ...
 */
class Invoiceamount extends \AppBundle\Entity\Invoiceamount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'paiddate', 'amount', 'invoice', 'balance'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Invoiceamount $proxy) {
