 ...
 */
class Pinvoiceitem extends \AppBundle\Entity\Pinvoiceitem implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'product', 'hssncode', 'gst', 'mrp', 'quantity', 'unit', 'rate', 'discount', 'amount', 'pinvoice'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pinvoiceitem $proxy) {
    ...
    public function setPinvoice(\AppBundle\Entity\Pinvoice $pinvoice = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPinvoice', [$pinvoice]);

        return parent::setPinvoice($pinvoice);
    }
    ...
    public function getPinvoice()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPinvoice', []);

        return parent::getPinvoice();
    }
