 ...
 */
class Purchaselog extends \AppBundle\Entity\Purchaselog implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'product', 'supplier', 'pinvoice', 'quantity'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Purchaselog $proxy) {
