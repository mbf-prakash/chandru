 ...
 */
class Cashdiscount extends \AppBundle\Entity\Cashdiscount implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'cashdiscount', 'percentage', 'invoice'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Cashdiscount $proxy) {
