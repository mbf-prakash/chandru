 ...
 */
class Imagebrowser extends \AppBundle\Entity\Imagebrowser implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\Imagebrowser' . "\0" . 'imageFile', '' . "\0" . 'AppBundle\\Entity\\Imagebrowser' . "\0" . 'imageName'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Imagebrowser $proxy) {
