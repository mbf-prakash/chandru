...
class __TwigTemplate_771e6b2031f45f9c568daf6900dd98b23f88e8ac2c1a8851130308edfb3f95cf extends Twig_Template
{
    private $source;
...
<div class=\"row paddleft-18\">
  ...
  <div class=\"col-sm-6\">
    <h2>Customer</h2>
     ...
     <div class=\"col-sm-6 text-right\">
    <a href=\"{{ path('addcustomer') }}\" class=\"btn btn-success add-btn\"><i class=\"fa fa-plus add-icon\" aria-hidden=\"true\"></i> Add New</a>
    </div>
    </div>
    {{ grid(grid) }}
...
<!-- table ends here -->
 ...
 {% endblock %}", ":customer:index.html.twig", "/opt/bitnami/apache2/htdocs/chandru/app/Resources/views/customer/index.html.twig");
    }
}
