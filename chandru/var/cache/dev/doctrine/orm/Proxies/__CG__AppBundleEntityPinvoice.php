 ...
 */
class Pinvoice extends \AppBundle\Entity\Pinvoice implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'supplier', 'invoicenumber', 'invoicedate', 'subtotal', 'cgst', 'balance', 'sgst', 'igst', 'grandtotal', 'status', 'paiddate'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Pinvoice $proxy) {
